        ...
        <div className="hero h-[400px]" style={{ backgroundImage: 'url(https://i.ibb.co/6nMKLGW/team.jpg)' }}>
            ...
            <div className="hero-content text-center text-neutral-content">
                <div className="max-w-md">
                    ...
                    <input className="px-2 py-1 bg-white border border-gray-300 rounded-md" type="text" placeholder="Search Here..." />
                    <button className="text-white bg-red-500 font-bold, px-2 py-1 rounded-md">Search</button>
                </div>
            </div>
        </div>
    );
